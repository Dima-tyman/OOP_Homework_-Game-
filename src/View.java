...
public class View {
    ...
    public static void view() {
        ...
        System.out.print("|    ");
        System.out.print(Game.holyTeam.get(0).getInfo());
        tabSetter(Game.holyTeam.get(0).getInfo().length(), l[0]);
        System.out.println(Game.darkTeam.get(0).getInfo());
        ...
        for (int i = 2; i < 10; i++) {
            ...
            System.out.print("|    ");
            System.out.print(Game.holyTeam.get(i-1).getInfo());
            tabSetter(Game.holyTeam.get(i-1).getInfo().length(), l[0]);
            System.out.println(Game.darkTeam.get(i-1).getInfo());
            System.out.println(midl10);
        }
        ...
        System.out.print("|    ");
        System.out.print(Game.holyTeam.get(9).getInfo());
        tabSetter(Game.holyTeam.get(9).getInfo().length(), l[0]);
        System.out.println(Game.darkTeam.get(9).getInfo());
